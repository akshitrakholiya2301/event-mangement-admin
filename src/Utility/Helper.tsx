...
export const excludeTokenAPIList: Array<string> = [GET_LOGIN_DATA_API, "/pay"];
...
export const getProfile = (): returnTypeForString => {
...
export const convertDecimalTwoPoint = (value: number): any => {
  return (Math.round(value * 100) / 100).toFixed(2);
}

export const checkFileSize = (fileSize, checkSize) => {
  const fileSIzeInMb = +convertDecimalTwoPoint(fileSize / (1024 ** 2));
  let valid = true;
  if (fileSIzeInMb > checkSize) {
    valid = false;
    return valid;
  }
  return valid;
