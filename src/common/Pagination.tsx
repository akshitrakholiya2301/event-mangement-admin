      ...
      <div className='pagination-container'>
        ...
        <div className='pagination-right'>
          <ul>
            ...
            })} ><Button size="sm" onClick={onPrevious}><i className='th-outline-arrow-left-2'></i></Button></li>
            ...
            {paginationRange?.map((pageNumber) => {
              ...
              return (
                ...
                ><Button variant="primary" size="sm" onClick={() => onPageChange(pageNumber)}>{pageNumber}</Button>
            ...
            })}><Button size="sm" onClick={onNext}><i className='th-outline-arrow-right-3'></i></Button></li>
          </ul>
