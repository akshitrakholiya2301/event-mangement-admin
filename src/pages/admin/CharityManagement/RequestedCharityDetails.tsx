...
const RequestedCharityDetails = (props) => {
    return (
        <>
                        ...
                        <div className="single-charity-content">
                            ...
                            <div className="single-charity-content-right">
                                <div className="single-charity-action-btn">
                                    ...
                                    <Button variant='outline-primary' size='sm' className='btn-icon-start'><i className='th-outline-tick-circle'></i> Approve </Button>
                                    <Button variant='outline-secondary' size='sm' className='btn-icon-start'><i className='th-outline-close-circle'></i> Decline </Button>
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestedCharityDetails)