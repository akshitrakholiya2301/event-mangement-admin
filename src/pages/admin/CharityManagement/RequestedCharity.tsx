...
const RequestedCharity = (props) => {
    ...
    const requestedCharityDetails = () => {
        navigate(ENUMFORROUTES.REQUESTED_CHARITY_DETAILS);
    };
                            ...
                            !isEmptyObjectOrNullUndefiend(listData) ? listData.map((item, index) => {
                                ...
                                return (
                                    <Col md={4} key={index} >
                                        ...
                                        // onClick={requestedCharityDetails}
                                                ...
                                                <div className="charity-card">
                                                    ...
                                                    <div className="charity-card-details">
                                                        <div className="per-month-charity">
                                                            <p> <img src={priority} alt="priority" /> {!isNullUndefinedOrBlank(item?.monthly_amount) ? item?.monthly_amount : "0"}</p>
                                                        </div>
                                    ...
                                    return (
                                        <>
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td> <div dangerouslySetInnerHTML={{ __html: item?.description as any }}>
