                                            ...
                                            <tr key={index}>
                                                <td className=''>
                                                    <div className="table-blog-deatils">
                                                        ...
                                                        <div className="table-blog-deatils-deatils-text">
                                                            <h6 onClick={() => { props.handleEdit(ENUMFORROUTES.SINGLE_BLOG, item, "View") }}>{(!isNullUndefinedOrBlank(item.heading)) ? item.heading : "-"}</h6>
                                                ...
                                                <td className='tbl-action'>
                                                    <div className="tbl-action-group">
                                                        ...
                                                        >
                                                            <Button variant='action' className='' onClick={() => { props.handleEdit(ENUMFORROUTES.CREATE_BLOG, item, "Edit") }}><i className='th-outline-edit'></i></Button>
                                                        </OverlayTrigger>
                                                        {
                                                            (item.status === ENUM_FOR_BLOG_STATUS.Unpublished) &&
                                                            ...
                                                            >
                                                                <Button variant='action' className='' onClick={() => { props.handlePublish(item.id) }}><i className='th-outline-tick-circle'></i></Button>
                                                            </OverlayTrigger>
                                                        }
                                                        {
                                                            (item.status !== ENUM_FOR_BLOG_STATUS.Unpublished) &&
                                                            ...
                                                            >
                                                                <Button variant='action' className='' onClick={() => { props.handleUnPublish(item.id) }}><i className='th-outline-slash'></i></Button>
                                                            </OverlayTrigger>
                                                        }
                                                        <OverlayTrigger
                                                            trigger={["hover", "hover"]}
