                        ...
                        {/* <tr>
                            <td className=''>
                                <div className="table-blog-deatils">
                                    <img src={defaultAvatar} alt="defaultAvatar2" />
                            ...
                            <td className=''>
                                12 March 2024 <br /><span className='text-warning'>Pending</span>
                            </td>
                            <td className=''>
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td className='tbl-action'>
                                                    <div className="tbl-action-group">
                                                        ...
                                                        >
                                                            <Button variant='action' className='' onClick={() => { props.handleReject(item.id) }}><i className='th-outline-close-circle'></i></Button>
                                                        </OverlayTrigger>
                                                    </div>
                                                </td>
                                            </tr>
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestedBlogs)