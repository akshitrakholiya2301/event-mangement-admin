...
```
git clone https://github.com/BelieveInYourselfOrg/ProjectPureCharityFEAdmin.git
```
2. Navigate to the project directory:
```
cd ProjectPureCharityFEAdmin
```
...
This command will start the development server and automatically open your default browser to [localhost:4000](http://localhost:4000/).
